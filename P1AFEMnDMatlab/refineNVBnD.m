...
% arrays get enlarged within the function before they are returned. The
% cell array varargin assembles boundary arrays and as last element a
% vector with element numbers that are marked for refinement.
%
% Comments:
