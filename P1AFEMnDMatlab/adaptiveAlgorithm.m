...
% given by the function handles f, g, uD, and object D, including D.A, D.b
% and D.c. The maximal number of elements nEmax and the refinement
% parameter eta define the stopping criterion and the adaptivity of the
% mesh. As output, the mesh is updated and is returned in the same format 
% as the input mesh. Additionally, the solution x is given as a vector.
%
% Comments:
