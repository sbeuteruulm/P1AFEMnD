...
% types. For each element, the neighbour numbers are returned in the rows of
% array element2neighbour. In hyperface2elements each row contains the pair
% of elements that share a hyperface.
%
%Comments:
